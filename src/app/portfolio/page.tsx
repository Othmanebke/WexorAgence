  ...
  return (
    ...
    >
      ...
      <section className="w-full px-6 md:px-8 py-0 bg-[#f0f0ee] relative">
        ...
        {/* Floating cursor image on hover */}
        <div
          className="hidden lg:block fixed pointer-events-none z-40 overflow-hidden w-72 h-48"
          style={{
            left: mousePos.x + 32,
            top: mousePos.y - 96,
          }}
                ...
                <TiltCard>
                  <div className="relative bg-abcs-black overflow-hidden h-64 md:h-80 group">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 flex items-end justify-between">
                      <div>
                        <p className="font-bold text-white/60 text-[10px] uppercase tracking-widest mb-1">{p.cat} · {p.year}</p>
                    ...
                    {/* Fashion label */}
                    <div className="absolute top-4 left-4 text-white/30 font-bold text-[9px] uppercase tracking-widest">{String(i + 1).padStart(2, "0")}</div>
                  </div>
                </TiltCard>
              </FadeUp>
            ))}
